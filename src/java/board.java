...
public class board {
    ...
    public void removeEdge(int source, int destination){ //add fence
    ...
    public boolean isValidFence(int playerPos, Player currentPlayer){
        ...
        // 72 is  starting point for range 72 -> 80. possible end points for player1(playerNo = true)
    ...
    public void printAdjGraph(){
        for(int i = 0; i < this.vertices; i++){
            for(int j = 0; j < this.vertices; j++){
                if(this.adjMatrix[i][j]){System.out.print("1 ");}
