...
public class ValidMoves {
    ...
    public void createValidFenceMovesList(Game game) {
        ...
        // creates valid move list
        // iterates over all squares on the board and checks which are possible to jump
        // to from cuurent position
        for (int i = 0; i < MAX_POSSIBLE_FENCE_ID; i++) {
            getCurrABCD(i);

            Fence fence = new Fence(i, getSecondId(i), isFenceHorizontal(i), CURRENT_A, CURRENT_B, CURRENT_C,
                    CURRENT_D);
